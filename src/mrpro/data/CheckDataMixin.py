...
class ShapeError(RuntimeCheckError):
    """A mismatch in the shape of a tensor."""


class DtypeError(RuntimeCheckError):
    """A mismatch in the dtype of a tensor."""
...
class CheckDataMixin:
    ...
    The shape of a field has to match the string specification. Named dimensions have to be the same over all annotated fields.
