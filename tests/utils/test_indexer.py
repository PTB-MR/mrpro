...
@pytest.mark.parametrize(
    ...
    [
        ...
        ((5, 1, 1), (5, 6, 7), (slice(None), 2), (5, 1, 1)),  # integer indexing broadcast #4
        ((1, 1, 7), (5, 6, 7), (slice(1, 2), slice(None, None, 2), slice(1, None, 2)), (1, 1, 3)),  # slices #5
        ((5, 1, 1), (5, 6, 7), (torch.tensor([0, 2]),), (2, 1, 1)),  # array index #6
        ((1, 6, 1), (5, 6, 7), (slice(None), [0, 2]), (1, 2, 1)),  # integer list #7
        ((1, 1, 1), (5, 6, 7), (torch.tensor([0, 2]), slice(None), slice(None)), (1, 1, 1)),  # array index broadcast #8
        ((5, 1, 1), (5, 6, 7), (torch.tensor([0, 2]), slice(None), (0, 2)), (2, 1, 1, 1)),  # two array indicces #9
        ((5, 6, 7), (5, 6, 7), (slice(None), torch.tensor([1, 3]), slice(None)), (5, 2, 7)),  # 10
        ((5, 6, 7), (5, 6, 7), (slice(None), slice(None), torch.tensor([0, 5])), (5, 6, 2)),  # 11
        (
            (5, 6, 7),
            (5, 6, 7),
        ...
        ((5, 6, 7), (5, 6, 7), (torch.ones(5, 6, 7).bool(),), (210, 1, 1, 1)),  # 13
        (
            (5, 6, 7),
            (5, 6, 7),
        ...
        ((5, 6, 7), (5, 6, 7), (torch.ones(5).bool(), ...), (5, 6, 7)),  # 15
        ((5, 6, 7), (5, 6, 7), (torch.tensor([[0, 1], [2, 3]]), slice(None), slice(None)), (2, 2, 6, 7)),  # 16
        ((5, 1, 7), (5, 6, 7), (slice(None), torch.tensor([[1, 2], [3, 4]]), slice(None)), (1, 5, 1, 7)),  # 17
        ((5, 6, 7), (5, 6, 7), (slice(None), torch.tensor([True, False, True, True, False, True]), 0), (5, 4, 1)),  # 18
        ((5, 6, 7), (5, 6, 7), (torch.tensor([1, 3]), slice(None), torch.tensor([0, 5])), (2, 1, 6, 1)),  # 19
        ((5, 6, 7), (5, 6, 7), (None, slice(None), slice(None)), (1, 5, 6, 7)),  # 20
        ((5, 6, 7), (5, 6, 7), (None, None, slice(None), slice(None)), (1, 1, 5, 6, 7)),  # 21
        ((5, 6, 7), (5, 6, 7), (..., 0), (5, 6, 1)),  # 22
        ((5, 6, 7), (5, 6, 7), (slice(None), ..., slice(None)), (5, 6, 7)),  # 23
        ((5, 6, 7), (5, 6, 7), (1, ..., 3), (1, 6, 1)),  # 24
        ((5, 1, 7), (5, 6, 7), (torch.ones(1, 1, 1, dtype=torch.bool),), (5, 1, 7)),  # 25
        ((5, 1, 1), (5, 6, 7), (torch.ones(1, 6, 1, dtype=torch.bool),), (5, 1, 1)),  # 26
    ],
)
