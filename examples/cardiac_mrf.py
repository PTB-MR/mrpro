...
fname_t1_ref = Path(
    '/echo/_allgemein/projects/pulseq/measurements/2024-06-24_t1mes_cMRF_pulseq/meas_MID00033_FID05475_t1map_T1MES/dicom/170734_t1map_T1MES_MOCO_T1_0005/SCHUENKE_PHANTOM-0005-0001.dcm'
)
fname_t2_ref = Path(
    '/echo/_allgemein/projects/pulseq/measurements/2024-06-24_t1mes_cMRF_pulseq/meas_MID00039_FID05481_t2map_flash_T1MES/dicom/170854_t2map_flash_T1MES_MOCO_T2_0009/SCHUENKE_PHANTOM-0009-0001.dcm'
)

pname = Path('/echo/_allgemein/projects/pulseq/measurements/2024-06-24_t1mes_cMRF_pulseq/')
scan_name = Path(
    'meas_MID00027_FID05469_20240624_spiral_cMRF_705rep_trig_delay800ms_fov/meas_MID00027_FID05469_20240624_spiral_cMRF_705rep_trig_delay800ms_fov_with_traj.h5'
)
...
scan_name = Path(
    'meas_MID00019_FID05461_20240624_spiral_cMRF_705rep_trig_delay800ms/meas_MID00019_FID05461_20240624_spiral_cMRF_705rep_trig_delay800ms_with_traj.h5'
)

pname = Path('/echo/_allgemein/projects/pulseq/measurements/2024-06-27_cMRF_tests/')
scan_name = Path(
    'meas_MID00143_FID05777_20240627_spiral_cMRF_705rep_only_t1prep/meas_MID00143_FID05777_20240627_spiral_cMRF_705rep_only_t1prep_with_traj.h5'
)


pname = Path(
    '/echo/_allgemein/projects/pulseq/measurements/2024-07-10_t2prep_tests/meas_MID00018_FID06326_20240710_spiral_cMRF_705rep_trig_delay800ms/'
)
scan_name = Path('meas_MID00018_FID06326_20240710_spiral_cMRF_705rep_trig_delay800ms_with_traj.h5')


pname = Path(
    '/echo/_allgemein/projects/pulseq/measurements/2024-10-16_T1MES_cMRF/meas_MID00069_FID06447_20240716_spiral_cMRF_no_vds_705rep_trig_delay800ms/'
)
...
pname = Path(
    '/echo/_allgemein/projects/pulseq/measurements/2024-10-16_T1MES_cMRF/meas_MID00074_FID06452_20240716_radial_cMRF_with_prep_705rep_trig_delay800ms/'
)
...
pname = Path(
    '/echo/_allgemein/projects/pulseq/measurements/2024-10-17_T1MES_cMRF/meas_MID00049_FID06498_20240717_spiral_cMRF_705rep_trig_delay800ms/'
)
scan_name = Path('meas_MID00049_FID06498_20240717_spiral_cMRF_705rep_trig_delay800ms_with_traj.h5')
rr_duration = 1200

pname = Path(
    '/echo/_allgemein/projects/pulseq/measurements/2024-10-17_T1MES_cMRF/meas_MID00048_FID06497_20240717_radial_cMRF_705rep_trig_delay800ms/'
)
...
dcf_data_voronoi = rearrange(
    dcf_data_voronoi[dyn_idx.flatten(), ...], '(other k1) 1 k2 k0->other k2 k1 k0', k1=dyn_idx.shape[-1]
)
if False:
    ...
    dcf_data = (
        gradient_tensor_norm * ktraj_tensor_norm * torch.abs(torch.cos(gradient_tensor_angle - ktraj_tensor_angle))
    )
