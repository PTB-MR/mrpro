...
from mrpro.data import DcfData, KData
...
if used_trajectory == 'spiral':
    pname = Path(
        '/Users/kolbit01/Documents/PTB/Data/mrpro/brain_cmrf/meas_MID00027_FID08310_20240911_spiral_cMRF_705rep_trig_delay800ms/'
    )
    ...
    pname = Path(
        '//Users/kolbit01/Documents/PTB/Data/mrpro/brain_cmrf/meas_MID00025_FID08308_20240911_radial_cMRF_705rep_trig_delay800ms/'
    )
    ...
    raise ValueError(f'method {used_trajectory} not recognized')
...
if recon == 'direct':
    ...
    raise ValueError(f'recon {recon} not recognized.')
