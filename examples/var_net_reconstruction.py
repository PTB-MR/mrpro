...
data_file = Path('/echo/_allgemein/projects/MRpro/MRPro/2024_03_19/pulseq_data/radial_2D_with_traj/radial_2D_402spokes_golden_angle/pulseq_radial_2D_402spokes_golden_angle_with_traj.h5')
...
model = NUFFTCascade(acquisition_operator=acquisition_op,operator_norm=None, factor=0.98, max_iter=4)
...
# %%
# Artificial data
dcf_operator = mrpro.operators.DensityCompensationOp(2*torch.sqrt(direct_reconstruction_us.dcf.data)) ## 2*torch.sqrt() or not
